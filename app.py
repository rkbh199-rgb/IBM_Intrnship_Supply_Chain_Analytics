...
with tabs[0]:
    ...
    with col_right:
        ...
        fig.update_layout(xaxis_tickangle=-45, height=350)
        st.plotly_chart(fig, use_container_width=True, key="overview_monthly_profit")
    ...
    with col_a:
        ...
        st.plotly_chart(fig, use_container_width=True, key="overview_sales_by_market")
    ...
    with col_b:
        ...
        st.plotly_chart(fig, use_container_width=True, key="overview_delivery_status_pie")
...
with tabs[1]:
    ...
    with col1:
        ...
        st.plotly_chart(fig, use_container_width=True, key="sales_profit_by_market")
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True, key="sales_profit_by_dept")
    ...
    with col3:
        ...
        st.plotly_chart(fig, use_container_width=True, key="sales_profit_scatter")
    ...
    with col4:
        ...
        st.plotly_chart(fig, use_container_width=True, key="sales_margin_by_market")
    ...
    st.plotly_chart(fig, use_container_width=True, key="sales_yearly_comparison")
...
with tabs[2]:
    ...
    with col1:
        ...
        st.plotly_chart(fig, use_container_width=True, key="customer_segment_pie")
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True, key="customer_sales_by_segment")
    ...
    with col3:
        ...
        st.plotly_chart(fig, use_container_width=True, key="customer_profit_by_segment")
    ...
    with col4:
        ...
        st.plotly_chart(fig, use_container_width=True, key="customer_payment_type")
    ...
    st.plotly_chart(fig, use_container_width=True, key="customer_top20")
...
with tabs[3]:
    ...
    with col1:
        ...
        st.plotly_chart(fig, use_container_width=True, key="product_sales_by_category")
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True, key="product_sales_by_dept")
    ...
    with col3:
        ...
        st.plotly_chart(fig, use_container_width=True, key="product_top15_by_sales")
    ...
    with col4:
        ...
        fig.update_layout(height=500)
        st.plotly_chart(fig, use_container_width=True, key="product_top15_by_profit")
    ...
    st.plotly_chart(fig, use_container_width=True, key="product_margin_by_category")
...
with tabs[4]:
    ...
    with col1:
        ...
        st.plotly_chart(fig, use_container_width=True, key="ship_mode_pie")
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True, key="ship_late_rate_by_mode")
    ...
    with col3:
        ...
        st.plotly_chart(fig, use_container_width=True, key="ship_avg_delay_by_mode")
    ...
    with col4:
        ...
        st.plotly_chart(fig, use_container_width=True, key="ship_order_status_dist")
    ...
    st.plotly_chart(fig, use_container_width=True, key="ship_late_by_region")
    ...
    if "Order Year" in df.columns and deliver_data["late_by_year"].shape[0] > 0:
        ...
        st.plotly_chart(fig, use_container_width=True, key="ship_late_rate_trend")
...
with tabs[5]:
    ...
    with col1:
        ...
        st.plotly_chart(fig, use_container_width=True, key="geo_sales_by_market")
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True, key="geo_profit_by_market")
    ...
    fig.update_layout(height=450)
    st.plotly_chart(fig, use_container_width=True, key="geo_sales_by_region")
    ...
    fig.update_layout(height=550)
    st.plotly_chart(fig, use_container_width=True, key="geo_sales_by_country")
